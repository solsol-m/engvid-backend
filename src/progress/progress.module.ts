import { Module, Injectable, Controller, Get, Post, Param, Body, UseGuards, Request } from '@nestjs/common';
...
export class ProgressService {
    ...
    async upsert(userId: string, videoId: string, percent: number, lastPositionSeconds: number) {
...
export class ProgressController {
    ...
    update(
        ...
        return this.progressService.upsert(
            req.user.userId, videoId, body.percent, body.lastPositionSeconds,
        );
    }
}
